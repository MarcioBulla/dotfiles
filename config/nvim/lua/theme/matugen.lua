 ...
 function M.setup()
   require('base16-colorscheme').setup {
     ...
     base09 = '#dec38c', -- Integers, Constants
     base0A = '#e7bdb6', -- Classes, Search Background
     base0B = '#ffb4a9', -- Strings, Diff Inserted
     base0C = '#dec38c', -- Regex, Escape Chars
     base0D = '#ffb4a9', -- Functions, Methods
 ...
 signal:start(
   ...
   vim.schedule_wrap(function()
     package.loaded['theme.matugen'] = nil
